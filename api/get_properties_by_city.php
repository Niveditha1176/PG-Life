...
header('Content-Type: application/json');// allow ajax requests , prevents cross origin resource sharing.
// making an ajax request from the api folder to the react folder to share the data
